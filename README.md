...
- [Preql](https://github.com/erezsh/Preql) - Preql is an interpreted, relational programming language, that specializes in database queries and compiles to SQL. It is designed for use by data engineers, analysts and data scientists.
